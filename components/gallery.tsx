...
import Link from 'next/link'; // Ensure this is imported from 'next/link'
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-20 pointer-events-none">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            {/* UPDATED: Path changed to /gallery to hit your new page */}
            <Link 
              href="/gallery" 
              className="group relative flex items-center gap-6 border border-[#1a1a1a]/30 px-12 py-6 overflow-hidden transition-all hover:border-[#1a1a1a]"
            >
              <span className="text-[#1a1a1a] text-[10px] tracking-[0.4em] relative z-10 transition-colors duration-500 group-hover:text-white uppercase">
