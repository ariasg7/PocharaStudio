...
export function Hero() {
  ...
  // Smooth scroll handler for the Inquiry CTA button
      ...
      >
        ...
        >
          <button 
            ...
            className="group relative border border-white/40 px-12 py-5 hover:border-white text-white hover:text-black transition-colors duration-500 text-[10px] tracking-[0.25em] flex items-center gap-4 overflow-hidden uppercase"
          >
